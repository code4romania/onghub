...
export class DDLMigration1648760400000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "civic_center_service" ("id" SERIAL NOT NULL, "deleted_on" TIMESTAMP WITH TIME ZONE, "created_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying NOT NULL, "location_id" integer, "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE, "is_period_not_determined" boolean NOT NULL DEFAULT false, "short_description" character varying NOT NULL, "long_description" character varying NOT NULL, "age_categories" text NOT NULL, "has_online_access" boolean NOT NULL DEFAULT false, "online_access_link" character varying, "online_access_description" character varying, "has_email_phone_access" boolean NOT NULL DEFAULT false, "email_access" character varying, "phone_access" character varying, "email_phone_access_description" character varying, "has_physical_access" boolean NOT NULL DEFAULT false, "physical_access_address" character varying, "physical_access_description" character varying, "active" boolean NOT NULL DEFAULT true, "organization_id" integer NOT NULL, CONSTRAINT "PK_d38afda83145bafba8c8c0c6ac1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "organization_financial" ("id" SERIAL NOT NULL, "deleted_on" TIMESTAMP WITH TIME ZONE, "created_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "financial_type" "public"."organization_financial_financial_type_enum" NOT NULL, "number_of_employees" integer NOT NULL DEFAULT '0', "year" integer NOT NULL, "total" integer NOT NULL DEFAULT '0', "completion_status" "public"."organization_financial_completion_status_enum" NOT NULL DEFAULT 'Not Completed', "data" jsonb, "organizationId" integer, CONSTRAINT "PK_225f4b7944b681a60ad848b7616" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "organization_general" ("id" SERIAL NOT NULL, "deleted_on" TIMESTAMP WITH TIME ZONE, "created_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_on" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" text NOT NULL, "alias" text NOT NULL, "type" "public"."organization_general_type_enum" NOT NULL, "email" text NOT NULL, "phone" text NOT NULL, "year_created" integer NOT NULL, "cui" text NOT NULL, "raf_number" text NOT NULL, "short_description" text, "description" text, "logo" text, "website" text NOT NULL, "facebook" text, "instagram" text, "twitter" text, "linkedin" text, "tiktok" text, "donation_website" text, "redirect_link" text, "donation_sms" text, "donation_keyword" text, "contact_id" integer, "city_id" integer, "county_id" integer, CONSTRAINT "UQ_58fc88f8fe87816637a917bab2d" UNIQUE ("name"), CONSTRAINT "UQ_47e42462bf81ad236cb374f3294" UNIQUE ("alias"), CONSTRAINT "UQ_b8ce26c42c7d956c3cbd3e85a69" UNIQUE ("email"), CONSTRAINT "UQ_ddbc0472e616242c156ec1153a2" UNIQUE ("phone"), CONSTRAINT "UQ_5114f5d57b18322c6f9c4e57885" UNIQUE ("cui"), CONSTRAINT "UQ_2c684835ca5c25e3bec90b7be29" UNIQUE ("raf_number"), CONSTRAINT "REL_d4b57646df8b80c7d33743d45e" UNIQUE ("contact_id"), CONSTRAINT "PK_ee0586f7cd1c00ad40d85e5c2c1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "organization_general" ADD CONSTRAINT "FK_d4b57646df8b80c7d33743d45e2" FOREIGN KEY ("contact_id") REFERENCES "_contact"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    LEFT JOIN "user" "user" ON "user".organization_id = "organization".id AND "user".deleted_on IS NULL AND "user".role = 'employee'
...
group by yearly_status.year, yearly_status.status
  `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "organization_general" DROP CONSTRAINT "FK_d4b57646df8b80c7d33743d45e2"`);
