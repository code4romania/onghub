...
exports.canonicalize = exports.headerWhitelist = void 0;
const crypto_1 = __importDefault(require("crypto"));
// Only sign these headers
exports.headerWhitelist = [
    'authorization',
    'timestamp',
    'date',
    'content-length',
...
function canonicalize(method, uri, queryString = '', headers, data) {
    ...
    for (let [key, value] of Object.entries(headers)) {
        key = key.toLowerCase();
        if (!exports.headerWhitelist.includes(key)) {
            continue;
        }
    ...
    const dataHash = crypto_1.default.createHash('sha256').update(data, 'utf8').digest('hex');
    /*
