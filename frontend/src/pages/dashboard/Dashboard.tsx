...
import { AdminDashboardExtendedStatisticsMapping, AdminDashboardSimpleStatisticsMapping } from './constants/DashboardStatistics.constants';
    ...
    {oneOrganizationStatistics && (
      <div className='flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-4'>
          <p className="text-gray-800 font-titilliumBold text-3xl">Despre ONGHub</p>
          <div className='flex flex-col sm:flex-row gap-4'>
            <StatisticsCard stat={{ ...AdminDashboardSimpleStatisticsMapping.numberOfApps, count: oneOrganizationStatistics.hubStatistics.numberOfApplications }} />
            <StatisticsCard stat={{ ...AdminDashboardSimpleStatisticsMapping.numberOfActiveOrganizations, count: oneOrganizationStatistics.hubStatistics.numberOfActiveOrganizations }} />
          </div>
        </div>
      </div>
    )}
