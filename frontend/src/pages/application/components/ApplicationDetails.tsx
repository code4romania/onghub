  ...
  return (
    <div className="flex gap-4 mr-1 mb-1 relative sm:flex-row flex-col">
      ...
      <div className="flex flex-col gap-4 w-full h-full">
        ...
        {application?.videoLink && (<div className="w-full h-full bg-white shadow rounded-lg">
          ...
          <div className="lg:p-8 p-5">
            <iframe
              ...
              srcDoc={`<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=${application?.videoLink
                }><img src=https://img.youtube.com/vi/${application?.videoLink?.split('/')[application?.videoLink?.split('/').length - 1]
                }/hqdefault.jpg alt='${t(
