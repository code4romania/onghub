          ...
          <div className="w-full h-full bg-white shadow rounded-lg">
            ...
            <div className="lg:p-8 p-5">
              <iframe
                ...
                src={youtubeLink}
                srcDoc={`<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=${youtubeLink}?autoplay><img src=https://img.youtube.com/vi/${youtubeLink.split('/')[youtubeLink.split('/').length - 1].split('?')[0]
                  }/hqdefault.jpg alt='${t(
